...
{
    public class GM_Juggernaut : MonoBehaviour
    {
        public static GM_Juggernaut instance;
        ...
        private IEnumerator Init()
        {
            ...
            var gameType = GameModes.Types.Deathmatch;
        ...
        {
            NetworkingManager.RPC(typeof(GM_Juggernaut), nameof(GM_Juggernaut.RPC_SyncResponse), requestingPlayer, PhotonNetwork.LocalPlayer.ActorNumber);
        }
        ...
        public static void RPC_SyncResponse(int requestingPlayer, int readyPlayer)
        {
            ...
            {
                GM_Juggernaut.instance.RemovePendingRequest(readyPlayer, nameof(GM_Juggernaut.RPC_RequestSync));
            }
        }
        ...
        private IEnumerator WaitForSyncUp()
        {
            ...
            yield return this.SyncMethod(nameof(GM_Juggernaut.RPC_RequestSync), null, PhotonNetwork.LocalPlayer.ActorNumber);
        }
            ...
            if (playersAlive == 1)
            {
                ...
                if (PhotonNetwork.IsMasterClient)
                {
                    NetworkingManager.RPC(
                        typeof(GM_Juggernaut),
                        nameof(GM_Juggernaut.RPCA_NextRound),
        ...
        {
            var instance = GM_Juggernaut.instance;
