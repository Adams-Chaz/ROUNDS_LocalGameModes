...
{
    public class GM_DoubleUp : MonoBehaviour
    {
        public static GM_DoubleUp instance;
        ...
        private IEnumerator Init()
        {
            ...
            var gameType = GameModes.Types.DoubleUp;

            PlayerManager.instance.SetPlayersSimulated(false);
            PlayerAssigner.instance.maxPlayers = gameType.MaxPlayers;
        ...
        {
            NetworkingManager.RPC(typeof(GM_DoubleUp), nameof(GM_DoubleUp.RPC_SyncResponse), requestingPlayer, PhotonNetwork.LocalPlayer.ActorNumber);
        }
        ...
        public static void RPC_SyncResponse(int requestingPlayer, int readyPlayer)
        {
            ...
            {
                GM_DoubleUp.instance.RemovePendingRequest(readyPlayer, nameof(GM_DoubleUp.RPC_RequestSync));
            }
        }
        ...
        private IEnumerator WaitForSyncUp()
        {
            ...
            yield return this.SyncMethod(nameof(GM_DoubleUp.RPC_RequestSync), null, PhotonNetwork.LocalPlayer.ActorNumber);
        }
            ...
            if (playersAlive == 1)
            {
                ...
                if (PhotonNetwork.IsMasterClient)
                {
                    NetworkingManager.RPC(
                        typeof(GM_DoubleUp),
                        nameof(GM_DoubleUp.RPCA_NextRound),
        ...
        private IEnumerator DoStartGame()
        {
            ...
            UIHandler.instance.ShowJoinGameText("LETS GO!", PlayerSkinBank.GetPlayerSkinColors(1).winText);
            ...
            for (int i = 0; i < PlayerManager.instance.players.Count; i++)
            {
                ...
                yield return CardChoice.instance.DoPick(2, PlayerManager.instance.players[i].playerID, PickerType.Player);
        ...
        {
            var instance = GM_DoubleUp.instance;
