...
namespace LGM
{
    internal static class PickTimerHandler
    {
        ...
        internal static IEnumerator StartPickTimer(CardChoice instance)
        {
            ...
            timerCR = Unbound.Instance.StartCoroutine(PickTimerHandler.Timer(LGMMod.PickTimer));
            yield return new WaitForSecondsRealtime(LGMMod.PickTimer);
