...
namespace LGM
{
    class PrivateRoomHandler : MonoBehaviourPunCallbacks
    {
        ...
        override public void OnJoinedRoom()
        {
            ...
            if (LGMMod.DEBUG && PhotonNetwork.IsMasterClient)
            {
            ...
            if (PhotonNetwork.IsMasterClient)
            {
                ...
                {
                    GameModeManager.SetGameMode(GameModes.Types._armsRace);
                }
        ...
        override public void OnPlayerEnteredRoom(Photon.Realtime.Player newPlayer)
        {
            if (PhotonNetwork.IsMasterClient)
            {
                ...
                if (LGMMod.DEBUG && LGMMod.instance.gameObject.GetComponent<DebugWindow>().enabled)
                {
        ...
        private IEnumerator CreatePlayerCoroutine()
        {
            ...
            LGMMod.instance.SetSoundEnabled("PlayerAdded", false);
            yield return PlayerAssigner.instance.CreatePlayer(this.deviceToUse, false);
            LGMMod.instance.SetSoundEnabled("PlayerAdded", true);
